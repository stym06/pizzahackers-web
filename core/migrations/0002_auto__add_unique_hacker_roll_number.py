...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Hacker', fields ['roll_number']
        db.create_unique(u'core_hacker', ['roll_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Hacker', fields ['roll_number']
        db.delete_unique(u'core_hacker', ['roll_number'])
